...
from models import Source, Actuator, Actuation, Circulation, Circulations, Heart, Valve, BiVenCustom, find_one_to_zero, find_zero_to_one, ejected_volume
...
data = {"relative duration systole": 1/3, # relative duration of systole vs full cycle
        ...
        "bpm": 120, # characteristic bpm or actuation frequency
...
svr = lambda t: (2.0 / r_ref - Sigmoid(1.5 / r_ref, 20)(t) + Sigmoid(1.5 / r_ref, 25)(t)
                 + Sigmoid(1.5 / r_ref, 40)(t) - Sigmoid(1.5 / r_ref, 41)(t))
...
# heart
left_ventricle = LinearMembrane(0.0, data["ventricle left unstressed volume"] / v_ref,
                                data["pouch left unstressed volume"] / v_ref)

right_ventricle = LinearMembrane(0.0, data["ventricle right unstressed volume"] / v_ref,
                                 data["pouch right unstressed volume"] / v_ref)

heart = Heart(left_ventricle, right_ventricle)

# system
system = BiVenCustom(actuation, heart, circulations)
