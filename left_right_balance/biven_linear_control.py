...
from models import Source, Actuator, Actuation, Circulation, Circulations, Heart, Valve, BiVenControl, find_one_to_zero, find_zero_to_one, ejected_volume
...
# system
system = BiVenControl(actuation, heart, circulations)
