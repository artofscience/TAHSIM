...
from models import Source, Actuator, Actuation, Circulation, Circulations, Heart, Valve, BiVenNoControl, find_one_to_zero, find_zero_to_one, ejected_volume
...
svr = lambda t: 2.0 / r_ref - Sigmoid(1.0 / r_ref, 20)(t) + Sigmoid(2.0 / r_ref, 40)(t)
...
# system
system = BiVenNoControl(actuation, heart, circulations)
...
initial_guess_volumes = (0.0, 0.0, vl0, vr0, vs10, vs20, vp10, vp20, 2.8, 0.0)

no_actuation_cycles = 60


# solve dynamics
times, volumes, pressures, valves, control_vars = system.dynamics(initial_guess_volumes, no_actuation_cycles)
...
# pleft = 3.2 + (30* error + 1 * int_error )
# pright = 2.0 + (30 * error + 1 * int_error)
