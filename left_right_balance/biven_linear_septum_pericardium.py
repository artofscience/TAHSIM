...
from models import Source, Actuator, Actuation, Circulation, Circulations, Heart, Valve, BiVenSeptumPeri, find_one_to_zero, find_zero_to_one, ejected_volume
...
class SeptumPeriHeart(Heart):
    def __init__(self, left, right, septum, pericardium):
...
data = {"relative duration systole": 1/3, # relative duration of systole vs full cycle
        ...
        "septum unstressed volume": 0,
        "pericardium elastance": 0.1,
        "pericardium unstressed volume": 400 # equals unstressed volume of left and right ventricle
        }
...
septum = Septum(data["septum elastance"] / e_ref, data["septum unstressed volume"] / v_ref)
pericardium = Pericardium(data["pericardium elastance"] / e_ref, data["pericardium unstressed volume"] / v_ref)

heart = SeptumPeriHeart(left_ventricle, right_ventricle, septum, pericardium)

# system
system = BiVenSeptumPeri(actuation, heart, circulations)
